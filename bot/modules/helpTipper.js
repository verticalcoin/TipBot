...
exports.tiphelp = {
  ...
  process: function (bot, message) {
    // ⚡ Bolt: Batched Discord API calls from 7 to 2 to minimize network latency and avoid rate-limiting bottlenecks, while staying under the 2000 character limit per message.
    let msg1 =
