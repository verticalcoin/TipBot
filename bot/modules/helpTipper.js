...
exports.tiphelp = {
  ...
  process: function(bot, message) {
    // ⚡ Bolt: Batching API calls to reduce 7 network requests down to 2
    // We split into two messages to stay safely under Discord's 2000 character limit per message
    const part1 =
    ...
    message.author
      .send(part1)
      .catch(err => console.error('Error sending help part 1', err));
    message.author
      .send(part2)
      .catch(err => console.error('Error sending help part 2', err));
  }
};
