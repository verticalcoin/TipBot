  ...
  ufo.getBalance(tipper, 1, function (err, balance) {
    if (err) {
      ...
      message.channel.send({
        embed: {
          title:
            '**:bank::money_with_wings::moneybag:Uniform Fiscal Object (UFO) Balance!:moneybag::money_with_wings::bank:**',
          color: 1363892,
          fields: [
            {
              name: '__User__',
  ...
  getAddress(tipper, function (err, address) {
    if (err) {
      ...
      message.channel.send({
        embed: {
          title:
            '**:bank::card_index::moneybag:Uniform Fiscal Object (UFO) Address!:moneybag::card_index::bank:**',
          color: 1363892,
          fields: [
            {
              name: '__User__',
      ...
      ufo.sendFrom(tipper, address, Number(amount), function (err, txId) {
        if (err) {
          ...
          message.channel.send({
            embed: {
              title:
                '**:outbox_tray::money_with_wings::moneybag:Uniform Fiscal Object (UFO) Transaction Completed!:moneybag::money_with_wings::outbox_tray:**',
              color: 1363892,
              fields: [
                {
                  name: '__Sender__',
